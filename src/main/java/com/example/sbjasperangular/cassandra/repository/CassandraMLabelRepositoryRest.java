...
@RepositoryRestResource(collectionResourceRel = "all", path = "rest_resource_mlabel")
public interface CassandraMLabelRepositoryRest extends CassandraRepository<CassandraMLabel> {
/*
	// curl http://localhost:8080/rest/rest_resource_mlabel -i -XGET
	// curl http://localhost:8080/rest_repository/rest_resource_mlabel -i -XGET
