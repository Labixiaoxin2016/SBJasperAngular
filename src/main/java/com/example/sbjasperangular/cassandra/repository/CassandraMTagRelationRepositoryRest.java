...
@RepositoryRestResource(collectionResourceRel = "all", path = "rest_resource_mtagrelation")
public interface CassandraMTagRelationRepositoryRest extends CassandraRepository<CassandraMTagRelation> {
/*
	// curl http://localhost:8080/rest/rest_resource_mtagrelation -i -XGET
	// curl http://localhost:8080/rest_repository/rest_resource_mtagrelation -i -XGET
